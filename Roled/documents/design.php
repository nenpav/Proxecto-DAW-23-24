...
if($resultado = $conexionBBDD->query("SELECT * FROM design WHERE id_usuario='$user' LIMIT $limit OFFSET $offset")){
  ...
  <header>
    ...
    <nav>
      ...
      <ul id="menuMovil" class="navbar-nav d-none">
        ...
        <li><a href='./comunity.php' aria-label='Enlace a Explorar' >Explorar<span></span></a></li>
        <li><a href='./tienda.php' aria-label='Enlace a Tienda'>Tienda<span></span></a></li>
        <li><a href="./miPerfil.php" aria-label="Enlace a Mi Perfil">Mi Perfil<span></span></a></li> 
        <li><a href="./design.php" aria-label="Enlace a mis diseños" class='activa'>Mis Diseños<span></span></a></li>
